...
| :-- | :-- |
| 1 | Project scaffolding, API keys, basic UI wireframe |
| 2 | Photo upload, safe upload validation |
| 3 | Integrate image generation API, process photo |
| 4 | Integrate LLM story generation, join flows |
| 5 | Generate multi-chapter story and pull images |
| 6 | Assemble story+images into PDF, offer download |
| 7 | Bug fixing, polish, write documentation/demo |
