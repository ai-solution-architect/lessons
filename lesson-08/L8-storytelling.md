# Deep Learning Avançado: PLN, Visão Computacional e Séries Temporais

---

## L8: Resumo - Deep Learning: NLP, Visão Computacional e Séries Temporais
...
## L8: Linha do Tempo - Técnicas Avançadas de Deep Learning: PLN, VC e Séries Temporais
...
*   **Processo da Pipeline de Séries Temporais:**
    *   **Coleta de Dados (1):** Dados ordenados por tempo de APIs, bancos de dados, mercados financeiros, dispositivos IoT.
    *   **Pré-processamento de Dados (2):** Valores ausentes, detecção de outliers, reamostragem, normalização.
    *   **Engenharia de Recursos (3):** Recursos de atraso, estatísticas de rolamento, sazonalidade, recursos baseados em decomposição.
...
*   **Ferramentas Populares:** pandas, NumPy, statsmodels, scikit-learn, Prophet, TensorFlow, PyTorch, sktime.
*   **Prophet (do Facebook):** Ferramenta escalável para previsão com componentes de tendência + sazonalidade + feriados. Robusto a outliers e dados ausentes, fácil de interpretar e ajustar, segue a API do modelo sklearn.
*   **Resumo de Séries Temporais:** Tabela que resume Componentes (Estatísticos Tradicionais, Baseados em RNN, Baseados em CNN, Baseados em Transformer, Híbridos), Propósito, Modelos Chave, Casos de Uso e Complexidade.
...
1.  **Faisal Nazir:**
    *   **Biografia:** O arquiteto de soluções de IA e instrutor da "Lição 8 - Técnicas Avançadas de Deep Learning". Ele é responsável por apresentar e explicar os conceitos de PLN, Visão Computacional e Análise de Séries Temporais dentro do contexto de arquitetura de soluções de IA.
2.  **Facebook (Meta):**
    *   **Biografia:** Uma empresa de tecnologia global reconhecida por suas contribuições em inteligência artificial. Eles desenvolveram e lançaram o Prophet, uma ferramenta escalável para previsão de séries temporais, que é destacada na lição como um modelo chave para a análise de séries temporais.
...
## L8: Guia - Guia de Deep Learning Avançado: PLN, Visão, Séries Temporais
...
## L8: FAQ - Deep Learning: RNN, PLN, CV e Séries Temporais

Aqui está um FAQ de 8 perguntas com respostas detalhadas, capturando os principais temas e ideias das fontes fornecidas:
